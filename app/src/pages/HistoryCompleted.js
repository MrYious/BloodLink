import { FaExclamation, FaRegStar, FaStar, FaTimes } from 'react-icons/fa';
...
const HistoryCompleted = () => {
  ...
  const fetchAllCompletedRequests = () => {
    const data = {
      id: userId,
      status: 'Completed',
    }
    ...
    .then(function (response) {
      console.log('Completed Requests ', response.data.requests);
        ...
        <div className="flex min-h-[90vh]">
          ...
          <div className="flex items-start justify-center w-full gap-5 p-5 bg-gray-100">
            ...
            <div className="bg-gray-50 w-[100%] lg:w-[65%] flex flex-col p-5 gap-3 rounded drop-shadow-lg">
              <div className="font-bold">HISTORY: LIST OF COMPLETED REQUESTS</div>
              {
                          ...
                          <div className='flex flex-col w-full gap-2 p-2 text-sm'>
                            ...
                            <div className='flex items-center gap-2'>
                              ...
                              <div className='text-base font-semibold shrink-0'>
                                {
                                  req.isDonor ? 'Blood Donor Review' : 'Your Review to Blood Donor'
                                }
                              </div>
                              <div className='w-full border border-black'></div>
                            </div>
                            ...
                            <div className='flex justify-center w-full gap-1 text-lg'>
                              {
