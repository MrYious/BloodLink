...
const HistoryDeclined = () => {
  ...
  const fetchAllDeclinedRequests = () => {
    const data = {
      id: userId,
      status: 'Declined',
    }
    ...
    .then(function (response) {
      console.log('Declined Requests ', response.data.requests);
        ...
        <div className="flex min-h-[90vh]">
          ...
          <div className="flex items-start justify-center w-full gap-5 p-5 bg-gray-100">
            ...
            <div className="bg-gray-50 w-[100%] lg:w-[65%] flex flex-col p-5 gap-3 rounded drop-shadow-lg">
              <div className="font-bold">HISTORY: LIST OF DECLINED REQUESTS</div>
              {
...
export default HistoryDeclined;